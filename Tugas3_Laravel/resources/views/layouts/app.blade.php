...
<head>
    ...
    <title>@yield('title', 'TokoKU - Toko Online Ter    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%); backdrop-filter: blur(10px); box-shadow: 0 8px 32px rgba(0,0,0,0.1);">`ercaya')</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        .hero-section::before {
            ...
            right: 0;
            bottom: 0;
            background: url('{{ asset('img/hero-bg.jpg') }}') center/cover;
            opacity: 0.1;
            z-index: 1;
        }
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); backdrop-filter: blur(10px); box-shadow: 0 8px 32px rgba(0,0,0,0.1);">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <!-- Search Form -->
                <form class="d-flex me-3 d-none d-md-flex" style="min-width: 250px;">
                    <div class="input-group">
                        <input class="form-control border-0 rounded-start-pill" type="search" placeholder="Cari produk..." aria-label="Search" style="background: rgba(255,255,255,0.1); color: white; backdrop-filter: blur(5px);">
                    ...
                    @else
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="#"><i class="fas fa-box me-2"></i>Pesanan</a></li>
        ...
        <div class="container py-5">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="text-white-50 mb-4">Toko online terpercaya dengan berbagai produk teknologi berkualitas tinggi untuk memenuhi kebutuhan digital Anda.</p>
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="contact-info">
                        <p class="mb-2 text-white-50">
                            <i class="fas fa-envelope me-2"></i>info@tokoku.com
                        </p>
                        <p class="mb-2 text-white-50">
            ...
            <div class="text-center mt-4 pt-4 border-top border-secondary">
                <p class="mb-0 text-white-50">
                    &copy; 2025 <strong>TokoKU</strong>. All rights reserved. 
                    <span class="mx-2">|</span>
                    <a href="#" class="text-white-50 text-decoration-none hover-link">Privacy Policy</a>
                    <span class="mx-2">|</span>
